...
description: "Reclaiming the never-used § key at the top left of a British keyboard and turning it into the # I hit a hundred times a day."
date: 2024-05-10
tags:
  - macOS
  - Markdown
redirectFrom:
  - /2024/05/10/markdown-heaven-mapping.html
---
...
[British Markdown.bundle](/assets/files/british-markdown.zip) (zip)
...
![The Library / Keyboard Layouts folder in Finder](/assets/images/library-keyboard-layouts.png)
...
![System Settings showing Keyboard Input Sources](/assets/images/system-settings-keyboard.png)
